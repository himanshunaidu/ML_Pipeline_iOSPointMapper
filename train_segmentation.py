...
from train.semantic_segmentation.train_eval import train_seg as train
from train.semantic_segmentation.train_eval import val_seg as val
from torch.utils.tensorboard import SummaryWriter
from train.semantic_segmentation.loss_functions.segmentation_loss import SegmentationLoss
import random
import math
import time
import numpy as np
...
def main(args):
    ...
    if args.dataset == 'pascal':
        from data_loader.semantic_segmentation.voc import VOCSegmentation, VOC_CLASS_LIST
...
if __name__ == "__main__":
    ...
    if not args.finetune:
        from model.semantic_segmentation.espnetv2.classification_submodule.weight_locations import model_weight_map
