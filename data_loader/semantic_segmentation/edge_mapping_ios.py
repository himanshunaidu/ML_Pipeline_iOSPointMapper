...
from data_loader.semantic_segmentation.edge_mapping_ios_scripts.custom_maps import edge_mapping_ios_dict, \
    edge_mapping_ios_to_cocoStuff_custom_35_dict, edge_mapping_ios_to_cocoStuff_custom_11_dict, \
    edge_mapping_ios_to_cocoStuff_custom_9_dict, edge_mapping_ios_to_cityscapes_dict, \
    edge_mapping_ios_to_cocoStuff_custom_35_dict_deprecated

# EDGE_MAPPING_IOS_CLASS_LIST = ['road', 'sidewalk', 'building', 'wall', 'fence', 'pole', 'traffic light', 'traffic sign',
#                         'vegetation', 'terrain', 'sky', 'person', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle',
#                         'bicycle', 'background']

custom_mapping_dicts = {
    'city': edge_mapping_ios_to_cityscapes_dict,
    # '53': edge_mapping_ios_to_cocoStuff_custom_53_dict,
    ...
    '35_deprecated': edge_mapping_ios_to_cocoStuff_custom_35_dict_deprecated
}

def get_edge_mapping_ios_num_classes(is_custom=False, custom_mapping_dict_key=None):
    """
    Returns the number of classes in the Edge Mapping iOS dataset.
    ...
    # else:
    return len(edge_mapping_ios_dict.keys())  # Default number of classes in Edge Mapping iOS without custom mapping

def get_edge_mapping_ios_mean_std():
    """
    Returns the mean and standard deviation values for Edge Mapping iOS dataset.
    """
    mean = (0.3257, 0.3690, 0.3223)
    std = (0.2112, 0.2148, 0.2115)
    return mean, std

class EdgeMappingIOSDataset(data.Dataset):
    """
