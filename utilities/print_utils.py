"""
This utility file contains functions to print messages in different colors and formats.
It utilizes ANSI escape codes to print messages in different colors.
"""
import time
